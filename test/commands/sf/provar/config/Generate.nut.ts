...
describe('Config generate', () => {
  ...
  it('Boilerplate json file should be generated with "-p" flag when no path is defined', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(`${sfProvarConfigGenerateCommand} -p provardx-properties.json`, {
      ensureExitCode: 0,
    }).shellOutput;
  ...
  it('Boilerplate json file should be generated with "--properties-file" flag when no path is defined', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(
      `${sfProvarConfigGenerateCommand} --properties-file test_file.json`,
      {
        ensureExitCode: 0,
      }
    ).shellOutput;
  ...
  it('Boilerplate json file should be overwritten when "-n" flag is provided with flag "-p" ', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(
      `${sfProvarConfigGenerateCommand} -p provardx-properties.json -n`,
      {
        ensureExitCode: 0,
      }
    ).shellOutput;
  ...
  it('Boilerplate json file should be generated with "-p" flag using relative path', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(`${sfProvarConfigGenerateCommand} -p ./test/XYZ.json`, {
      ensureExitCode: 0,
    }).shellOutput;
    expect(res['stdout']).to.deep.equal(successMessage);
  });
  ...
  it('Boilerplate json file should be generated with "-p" flag and with special char in file name', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(
      `${sfProvarConfigGenerateCommand} -p .\\test\\assertion\\D#um$.json`,
      {
        ensureExitCode: 0,
      }
    ).shellOutput;
  ...
  it('Boilerplate json file should not be generated with "-p" flag as path is invalid', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(`${sfProvarConfigGenerateCommand} -p a/aa.json`).shellOutput;
  ...
  it('Boilerplate json file should not be generated with "-p" flag as extension is invalid', () => {
    const res = execCmd<SfProvarConfigGenerateResult>(`${sfProvarConfigGenerateCommand} -p ./test/Dom.txt`).shellOutput;
  ...
  it('Boilerplate json file should be generated with "-p" flag and return the result in json format', () => {
    const result = execCmd<SfProvarConfigGenerateResult>(`${sfProvarConfigGenerateCommand} -p xyz.json --json`, {
      ensureExitCode: 0,
    });
  ...
  it('Boilerplate json file should not be generated with "-p" flag as path is invalid and return the result in json format', () => {
    const result = execCmd<SfProvarConfigGenerateResult>(`${sfProvarConfigGenerateCommand} -p x/xyz.json --json`, {
      ensureExitCode: 0,
    });
  ...
  it('Boilerplate json file should not be generated with "--properties-file" flag as invalid file extension and return the result in json format', () => {
    const result = execCmd<SfProvarConfigGenerateResult>(
      `${sfProvarConfigGenerateCommand} --properties-file Ani.bat --json`,
      {
        ensureExitCode: 0,
      }
    );
