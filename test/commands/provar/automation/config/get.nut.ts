...
import { commandConstants, errorMessages, SfProvarCommandResult } from '@provartesting/provardx-plugins-utils';
...
describe('sf provar config get NUTs', () => {
  ...
  it('Missing file error in json format as json file is not loaded', () => {
    const result = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} resultsPath --json`,
      {
        ensureExitCode: 0,
      }
    );
  ...
  it('Missing property error as property name is missing', () => {
    ...
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND}`
    ).shellOutput;
  ...
  it('Missing property error in json format as property name is missing', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} --json`
    ).jsonOutput;
  ...
  it('Unknown Property error as property is not present in the file', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} metadata.test`
    ).shellOutput;
  ...
  it('Unknown Property error as property is not present in the file', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} environment.webBrowserProvider`
    ).shellOutput;
    expect(getOutput.stderr).to.deep.equal(`Error (1): [UNKNOWN_PROPERTY] ${errorMessages.UNKNOWN_PROPERTY}\n\n`);
  });
  ...
  it('Unknown Property error as property is not present in the file', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} projectPath.web`
    ).shellOutput;
    expect(getOutput.stderr).to.deep.equal(`Error (1): [UNKNOWN_PROPERTY] ${errorMessages.UNKNOWN_PROPERTY}\n\n`);
  });
  ...
  it('Unknown Property error in json format as property is not present in the file', () => {
    const result = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} sample --json`,
      {
        ensureExitCode: 0,
      }
    );
  ...
  it('value should be returned for provarHome property', () => {
    ...
    execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_SET_COMMAND} provarHome=${setProvarHome}`
    );
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} provarHome`
    ).shellOutput;
  ...
  it('value should be returned for projectPath property', () => {
    ...
    const output = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} projectPath`
    ).shellOutput;
    expect(output.stdout).to.deep.equal('${PROVAR_PROJECT_PATH}\n');
    execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_SET_COMMAND} projectPath=${setProjectPath}`
    );
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} "projectPath"`
    ).shellOutput;
  ...
  it('value should be returned for resultsPath property in json format', () => {
    execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_SET_COMMAND} "resultsPath"="C:/Users/anchal.goel/git/ProvarRegressionqam5/test/provardx/Results"`
    );
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} resultsPath --json`,
      {
  ...
  it('value should be returned for smtpPath property', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} "smtpPath"`
    ).shellOutput;
  ...
  it('Value should be returned successfully for metdata object', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} metadata`
    ).shellOutput;
  ...
  it('Value should be returned successfully for environment object in json format', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} environment --json`,
      {
        ensureExitCode: 0,
      }
    );
  ...
  it('Value should be returned successfully for testEnvironment property in environment object', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} environment.testEnvironment`
    ).shellOutput;
  ...
  it('Value should be returned successfully for webBrowserDeviceName property in environment object', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} "environment"."webBrowserDeviceName"`
    ).shellOutput;
  ...
  it('Value should be returned successfully for cachePath property in metadata object', () => {
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} metadata.cachePath --json`
    ).jsonOutput;
    expect(getOutput?.result.success).to.deep.equal(true);
  ...
  it('value should be returned for new added property', () => {
    execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_SET_COMMAND} "Test Suite"="Multiple Suites"`
    );
    const getOutput = execCmd<SfProvarCommandResult>(
      `${commandConstants.SF_PROVAR_AUTOMATION_CONFIG_GET_COMMAND} "Test Suite"`
    ).shellOutput;
