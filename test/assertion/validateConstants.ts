...
export const invalidValuesError =
  "Error (1): [INVALID_VALUES] The properties 'resultsPathDisposition', 'pluginOutputlevel', 'metadata.metadataLevel', 'environment.webBrowser' are not valid.\n";

export const multipleErrors =
  "Error (1): [MISSING_PROPERTY] The property 'provarHome' is missing. [INVALID_VALUES] The properties 'resultsPathDisposition', 'pluginOutputlevel', 'metadata.metadataLevel', 'environment.webBrowser' are not valid.\n";
    ...
    errors: [
      {
        ...
        errorMessage:
          "The properties 'resultsPathDisposition', 'pluginOutputlevel', 'metadata.metadataLevel', 'environment.webBrowser' are not valid.",
      },
    ],
  },
  warnings: [],
