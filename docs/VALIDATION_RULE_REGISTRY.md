...
**Counts:** Layer 1 — 26 rules (19 gating). Layer 2 — 180 rules (critical 64 / major 69 / minor 29 / info 18; 58 bridged to `is_valid`).
...
| `CUSTOM-FIELD-001` | NamingConventions | major | 5 | No | Custom fields end with __c. |
